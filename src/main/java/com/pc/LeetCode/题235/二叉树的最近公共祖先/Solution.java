...
public class Solution {
	...
	public static void main(String[] args) {
		...
		ll.add(TreeNode.listOfElecments(6));
		ll.add(TreeNode.listOfElecments(2,8));
		ll.add(TreeNode.listOfElecments(0,4,7,9));
		ll.add(TreeNode.listOfElecments(null,null,3,5,null,null,null,null));
