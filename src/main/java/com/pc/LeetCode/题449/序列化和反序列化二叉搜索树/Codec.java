...
public class Codec {
    ...
    public static void main(String[] args) {
        ...
        ll.add(TreeNode.listOfElecments(8));
        ll.add(TreeNode.listOfElecments( 3,9));
        ll.add(TreeNode.listOfElecments(null,4,10, null));
        ll.add(TreeNode.listOfElecments(null,null,null,null,null,11,null,null));
